...
const Navbar = () => {
  ...
  const images = [
    img1, img2, img4, img5, img7, img8, img9, img10, img11, img12, img13, img14, img15, img16, img17, img18, img19, img20,
  ]
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'about', 'experience', 'project2', 'project3', 'contact']
      let newSection = 'hero'
      ...
      // Change image only when section actually changes
      if (newSection !== currentSection) {
        setCurrentSection(newSection)
        const newImageIndex = getRandomImageIndex()
        setCurrentImageIndex(newImageIndex)
        setPreviousImageIndex(newImageIndex)
      }
    }
    ...
    <div className="navbar">
        ...
        <div className="wrapper">
            <div className="social">
                <a href="https://github.com/ojaschatur" className="nav-link" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://www.linkedin.com/in/ojas-chatur-090823258/" className="nav-link" target="_blank" rel="noopener noreferrer">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <img 
                  ...
                  onMouseEnter={() => {
                    ...
                    setCurrentImageIndex(images.indexOf(img11))
                  }}
                  onMouseLeave={() => setCurrentImageIndex(previousImageIndex)}
                ...
                >
                  {isInstagramHovered ? (
                    <>
                      <img src={img11} alt="angry emoji" style={{ width: 40, height: 40, verticalAlign: 'middle' }} />
                      <span style={{ marginLeft: 6 }}>No No</span>
                    </>
                  ) : (
                    <>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a href="https://drive.google.com/file/d/14EjKb_X5BiRjdNrdH5aeK-GCZQ6-mX6k/view?usp=sharing" className="nav-link resume-link" target="_blank" rel="noopener noreferrer">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
